...
public class Token {
  ...
  public static final int PONTUACAO = 20;
    ...
    // NOVO
    // Adicionar às constantes de tipos de token
    public static final int FLOAT = 21;
    public static final int LAMBDA = 22;

    // Adicionar às constantes de palavras-chave (Java)
    ...
    // Adicionar às constantes de operadores
    public static final int LAMBDA_OP = 7;
  ...
  private String tipoString() {
    ...
    String resultado = "Erro";
      ...
      switch ( tipo ) {
	    ...
	    case PONTUACAO: resultado = "pontuação";break;
        case FLOAT: resultado = "float"; break;
        case LAMBDA: resultado = "lambda"; break;
        case CLASS: resultado = "class"; break;
        case PUBLIC: resultado = "public"; break;
        case PRIVATE: resultado = "private"; break;
        case NEW: resultado = "new"; break;
        case THIS: resultado = "this"; break;
        case IMPORT: resultado = "import"; break;
        case PACKAGE: resultado = "package"; break;
  ...
  private String tipoOP(Integer tipo1) {
    ...
    switch ( tipo1.intValue() ) {
      ...
      case DIV: resultado = "/";
        ...
        //NOVO
      case LAMBDA_OP: resultado = "->"; break;
    }
